<template>
  <v-container fluid class="pa-6">
    <div class="app-header-bar d-flex flex-wrap align-center justify-space-between mb-6 px-5 py-4 ga-3">
      <div>
        <h1 class="text-h5 font-weight-bold mb-0">Storefront Content</h1>
        <p class="text-body-2 text-medium-emphasis mb-0">
          Edit the copy shown on your public storefront home page - hero, promise, story, why-choose, philosophy and testimonials.
        </p>
      </div>
      <v-btn color="primary" prepend-icon="mdi-content-save" :loading="store.saving" @click="submit">
        Save Changes
      </v-btn>
    </div>
    ...
    <template v-else>
      <!-- Hero -->
      <div class="app-card pa-5 mb-5">
        <h2 class="text-subtitle-1 font-weight-bold mb-4">Hero</h2>
        <v-text-field v-model="form.heroTag" label="Tag line (small text above the headline)" variant="outlined" class="mb-2" />
        ...
        />
        <v-img v-if="form.heroImageUrl" :src="form.heroImageUrl" height="140" cover class="rounded-lg mt-2" />
      </div>

      <!-- Promise -->
      <div class="app-card pa-5 mb-5">
        <h2 class="text-subtitle-1 font-weight-bold mb-4">Our Promise</h2>
      ...
      <!-- Story -->
      <div class="app-card pa-5 mb-5">
        <h2 class="text-subtitle-1 font-weight-bold mb-4">Our Story</h2>
      ...
      <!-- Why Choose Us -->
      <div class="app-card pa-5 mb-5">
        <h2 class="text-subtitle-1 font-weight-bold mb-4">Why Choose Us</h2>
        <v-text-field v-model="form.whyChooseTitle" label="Section title" variant="outlined" class="mb-2" />
        <div v-for="(reason, i) in form.whyChooseItems" :key="i" class="why-row mb-3">
      ...
      <!-- Philosophy -->
      <div class="app-card pa-5 mb-5">
        <h2 class="text-subtitle-1 font-weight-bold mb-4">Our Philosophy</h2>
      ...
      <!-- Testimonials -->
      <div class="app-card pa-5 mb-5">
        <h2 class="text-subtitle-1 font-weight-bold mb-4">Testimonials</h2>
        <v-text-field v-model="form.testimonialsTitle" label="Section title" variant="outlined" class="mb-2" />
        <div v-for="(t, i) in form.testimonials" :key="i" class="testimonial-row mb-3">
...
function emptyForm() {
  return reactive({
    ...
    storyPillars: [''],
    whyChooseTitle: '',
    whyChooseItems: [{ icon: 'mdi-star-outline', title: '', body: '' }],
    philosophyTitle: '',
    philosophyLines: [''],
    testimonialsTitle: '',
